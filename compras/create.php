            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Registro de una nueva compra</li>
                    </ol>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="number" id="stock_maximo" class="form-control"
                                                        disabled>
                                                </div>
                                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="P_Nombre" type="text" class="form-control" disabled>

                                                <label for="Celular">Celular del proveedor</label>
                                                <input id="P_Celular" type="text" class="form-control" disabled>

                                                <label for="Telefono">Telefono del proveedor</label>
                                                <input id="P_Telefono" type="text" class="form-control" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="Empresa">Empresa del proveedor</label>
                                                <input id="P_Empresa" type="text" class="form-control" disabled>


                                                <label for="Correo">Correo del proveedor</label>
                                                <input id="P_Correo" type="email" class="form-control" disabled>


                                                <label for="Direccion">Direccion del proveedor</label>
                                                <input id="P_Direccion" type="text" class="form-control" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Fin modal -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?php echo $contador_compras; ?>" disabled>
                                                <input id="numero_compra" type="text"
                                                    value="<?php echo $contador_compras; ?>" hidden>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="Stock_actual" type="text" class="form-control" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="cantidad_compra" value="">
                                            </div>
                                            <script>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <button class="btn btn-primary btn-block"
                                                    id="btn_guardar_compra">Guardar compra</button>
                                            </div>
